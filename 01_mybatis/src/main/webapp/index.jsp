...
<body>
	...
	<form action="${path }/updateStudent.do" method="post">
		<input type="text" name="name" placeholder="수정할 학생번호"><br>
		<input type="text" name="phone" placeholder="전화번호"><br>
		<input type="email" name="email" placeholder="이메일"><br>
		<input type="text" name="address" placeholder="주소"><br>
	...
	<p>select문을 실행한 결과를 java에서 사용하는 vo객체에 저장</p>
	<p>조회한 결과를 vo에 저장하는것을 mybatis가 mapping정보를 이용해서 자동으로
	대입해준다.</p>
	<h3>학생수 조회하기</h3>
